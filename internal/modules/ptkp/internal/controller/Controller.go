...
import (
	...
	"github.com/ikti-its/khanza-api/internal/modules/ptkp/internal/model"
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	fmt.Println("Received a POST request to /ptkp") // Debugging log

...
type StokController struct {
	UseCase   *usecase.StokUseCase
	Validator *config.Validator
}

func NewStokController(useCase *usecase.StokUseCase, validator *config.Validator) *StokController {
...
func (c *StokController) Create(ctx *fiber.Ctx) error {
	var request model.StokRequest
...
func (c *StokController) Get(ctx *fiber.Ctx) error {
...
func (c *StokController) GetById(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
...
func (c *StokController) Update(ctx *fiber.Ctx) error {
	var request model.StokRequest
	id := ctx.Params("id")
...
func (c *StokController) Delete(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
	updater := ctx.Locals("user").(string)

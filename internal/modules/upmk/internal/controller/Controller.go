...
import (
	...
	"github.com/ikti-its/khanza-api/internal/modules/upmk/internal/model"
	"github.com/ikti-its/khanza-api/internal/modules/upmk/internal/usecase"
)
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	fmt.Println("Received a POST request to /upmk") // Debugging log

...
func KamarRoute(app *fiber.App, kamarController *controller.KamarController) {
	...
	kamar.Get("/available", kamarController.GetAvailableRooms)
	kamar.Get("/kelas", kamarController.GetKelasOptions)
	...
	kamar.Put("/:nomor_bed/status", kamarController.UpdateStatusKamar)

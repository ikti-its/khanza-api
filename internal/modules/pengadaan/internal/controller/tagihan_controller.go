...
type TagihanController struct {
	UseCase   *usecase.TagihanUseCase
	Validator *config.Validator
}

func NewTagihanController(useCase *usecase.TagihanUseCase, validator *config.Validator) *TagihanController {
...
func (c *TagihanController) Create(ctx *fiber.Ctx) error {
	var request model.TagihanRequest
...
func (c *TagihanController) Get(ctx *fiber.Ctx) error {
...
func (c *TagihanController) GetById(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
...
func (c *TagihanController) Update(ctx *fiber.Ctx) error {
	var request model.TagihanRequest
	id := ctx.Params("id")
...
func (c *TagihanController) Delete(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
	updater := ctx.Locals("user").(string)

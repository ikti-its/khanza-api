...
type PemesananController struct {
	UseCase   *usecase.PemesananUseCase
	Validator *config.Validator
}

func NewPemesananController(useCase *usecase.PemesananUseCase, validator *config.Validator) *PemesananController {
...
func (c *PemesananController) Create(ctx *fiber.Ctx) error {
	var request model.PemesananRequest
...
func (c *PemesananController) Get(ctx *fiber.Ctx) error {
...
func (c *PemesananController) GetById(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
...
func (c *PemesananController) Update(ctx *fiber.Ctx) error {
	var request model.PemesananRequest
	id := ctx.Params("id")
...
func (c *PemesananController) Delete(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
	updater := ctx.Locals("user").(string)

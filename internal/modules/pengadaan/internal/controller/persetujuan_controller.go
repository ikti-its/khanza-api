...
type PersetujuanController struct {
	UseCase   *usecase.PersetujuanUseCase
	Validator *config.Validator
}

func NewPersetujuanController(useCase *usecase.PersetujuanUseCase, validator *config.Validator) *PersetujuanController {
...
func (c *PersetujuanController) Get(ctx *fiber.Ctx) error {
...
func (c *PersetujuanController) GetById(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
...
func (c *PersetujuanController) Delete(ctx *fiber.Ctx) error {
	id := ctx.Params("id")
	updater := ctx.Locals("user").(string)

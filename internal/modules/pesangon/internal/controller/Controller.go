...
import (
	...
	"github.com/ikti-its/khanza-api/internal/modules/pesangon/internal/model"
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	fmt.Println("Received a POST request to /pesangon") // Debugging log
...
func (c *Controller) GetById(ctx *fiber.Ctx) error {
	nomorBed := ctx.Params("no_pesangon")

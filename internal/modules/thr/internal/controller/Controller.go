...
import (
	...
	"github.com/ikti-its/khanza-api/internal/modules/thr/internal/model"
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	fmt.Println("Received a POST request to /thr") // Debugging log

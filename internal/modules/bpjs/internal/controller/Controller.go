...
import (
	...
	"github.com/ikti-its/khanza-api/internal/modules/bpjs/internal/model"
	"github.com/ikti-its/khanza-api/internal/modules/bpjs/internal/usecase"
)
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	fmt.Println("Received a POST request to /bpjs") // Debugging log

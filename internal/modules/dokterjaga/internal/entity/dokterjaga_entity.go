...
type DokterJaga struct {
	...
	HariKerja  time.Time `json:"hari_kerja" db:"hari_kerja"`   // DATE
	JamMulai   string    `json:"jam_mulai" db:"jam_mulai"`     // TIME (stored as string in format "HH:MM:SS")
	JamSelesai string    `json:"jam_selesai" db:"jam_selesai"` // TIME

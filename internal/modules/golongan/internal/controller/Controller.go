...
import (
	...
	"github.com/ikti-its/khanza-api/internal/modules/golongan/internal/model"
	"github.com/ikti-its/khanza-api/internal/modules/golongan/internal/usecase"
)
...
func (c *Controller) Create(ctx *fiber.Ctx) error {
	...
	fmt.Println("Received a POST request to /golongan") // Debugging log
...
func (c *Controller) GetById(ctx *fiber.Ctx) error {
	nomorBed := ctx.Params("no_golongan")
